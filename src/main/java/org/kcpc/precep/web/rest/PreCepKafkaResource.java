...
@RestController
@RequestMapping("/api/pre-cep-kafka")
public class PreCepKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PreCepKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PreCepKafkaResource(KafkaProperties kafkaProperties) {
